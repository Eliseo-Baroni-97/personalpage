                    ...
                    <div className="tab-content mt-4">
                        ...
                        >
                            <div className="row row-cols-2">
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-html5 me-3"></i>
                                    <h5 className="mb-0">HTML5</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-css3 me-3"></i>
                                    <h5 className="mb-0">CSS3</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-bootstrap me-3"></i>
                                    <h5 className="mb-0">Bootstrap 4</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-git me-3"></i>
                                    <h5 className="mb-0">GIT</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-js me-3"></i>
                                    <h5 className="mb-0">JavaScript</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-database me-3"></i>
                                    <h5 className="mb-0">Localstorage</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-java me-3"></i>
                                    <h5 className="mb-0">Java</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-react me-3"></i>
                                    <h5 className="mb-0">React.js</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-leaf me-3"></i>
                                ...
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-shield-alt me-3"></i>
                        ...
                        >
                            <div className="row row-cols-2">
                                ...
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-paint-brush me-3"></i>
                        ...
                        >
                            <div className="row row-cols-2">
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-rocket me-3"></i>
                                    <h5 className="mb-0">Ganas de crecer</h5>
                                </div>
                                <div className="col p-3 d-flex align-items-center">
                                    <i className="fa fa-tasks me-3"></i>
